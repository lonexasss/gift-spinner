# 🎰 Gift Spinner — Telegram Mini App + Bot

Казино-крутилка кейсов с NFT/подарками (шанс редких ~0%) и гарантированным дропом **1–3 ⭐**.
Игрок выполняет задание (подписка на канал рекламодателя) → открывает кейс в **Mini App** (анимация, витрина с подарками) → звёзды на баланс.
